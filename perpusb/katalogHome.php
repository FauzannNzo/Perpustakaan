        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="katalogHome.php"><i class="fas fa-book me-1"></i>Katalog</a>
                    </li>
                        ...
                        <?php foreach ($data_buku as $buku): ?>
                            <div class="book-card">
                                ...
                                <div class="book-info">
                                    ...
                                    <div class="d-grid">
                                        <a href="d_bukuHome.php?id=<?= $buku['id_buku'] ?>" class="btn btn-outline-primary rounded-pill">
