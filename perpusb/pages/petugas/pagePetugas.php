...
$data_jumlah_petugas = select("SELECT COUNT(*) as total FROM login WHERE level='petugas'")[0]['total'];
...
<head>
    ...
    <title>Petugas - Perpustakaan Digital</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <a class="nav-link" href="dataSiswa.php"><i class="fas fa-user-graduate me-1"></i>Siswa</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="main-content">
        <div class="welcome-section">
            ...
            <p>Mengawasi perpustakaan digital dengan mudah dan efisien.</p>
        </div>
