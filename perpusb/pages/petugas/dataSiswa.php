...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="pagePetugas.php"><i class="fas fa-home me-1"></i>Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="dataSiswa.php"><i class="fas fa-user-graduate me-1"></i>Siswa</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="dataKategori.php"><i class="fas fa-book me-1"></i>Kategori</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="main-content">
        <div class="welcome-section">
            ...
            <p>Mengawasi data siswa dengan mudah dan efisien.</p>
        </div>
