...
<body>
    <div class="form-container">
        <div class="form-header">
            <h1>Tambah Buku</h1>
            <p>Silakan isi data buku baru</p>
        </div>
        ...
        <form action="" method="POST">
            ...
            <div class="form-floating">
                <input type="number" class="form-control" name="jumlah_buku" id="jumlah_buku" placeholder="Jumlah Buku" required>
                <label for="jumlah_buku">Jumlah Buku</label>
            </div>

            <div class="form-floating">
                <input type="text" class="form-control" name="cover" id="cover" placeholder="Cover" required>
                <label for="jumlah_buku">URL Cover</label>
            </div>

            <div class="form-floating">
                <textarea class="form-control" name="deskripsi" id="deskripsi" placeholder="Deskripsi" style="min-height: 100px; max-height: 250px; overflow:auto; resize:vertical;"></textarea>
            ...
            <a href="../pagePetugas.php" class="btn btn-back">
