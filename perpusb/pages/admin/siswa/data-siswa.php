...
$data_siswa = array_filter($data_akun, function ($akun) {
    return $akun['level'] == 'siswa';
});
?>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="data-siswa.php"><i class="fas fa-user-graduate me-1"></i>Siswa</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="main-content">
        ...
        <div class="card" id="siswa">
            ...
            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="ubah-data-siswa.php?id=<?= $siswa['id']; ?>" class="btn btn-sm btn-outline-primary">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="hapus-data-siswa.php?id=<?= $siswa['id']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Yakin ingin menghapus data ini?')">
                ...
                <a href="tambah-data-siswa.php?level=siswa" class="btn btn-primary mt-3">
