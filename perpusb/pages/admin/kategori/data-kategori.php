...
$data_kategori = select("SELECT k.*, COUNT(b.id_buku) as jumlah_buku 
                        FROM kategori k 
...
<head>
    ...
    <title>Data Kategori - Perpustakaan Digital</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="data-kategori.php"><i class="fas fa-book me-1"></i>Kategori</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="main-content">
        <div class="welcome-section">
            ...
            <p>Kelola data kategori dengan mudah dan efisien.</p>
        </div>
        ...
        <div class="card" id="kategori">
            ...
            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="hapusKategori.php?id=<?= $kategori['id_kategori']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Yakin ingin menghapus data ini?')">
                ...
                <a href="tambahKategori.php" class="btn btn-primary mt-3">
