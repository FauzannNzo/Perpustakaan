...
<head>
    ...
    <title>Detail Buku - Perpustakaan Digital <?= htmlspecialchars($buku['judul_buku']) ?></title>
    ...
    <div class="detail-card">
        ...
        <div class="detail-info">
            ...
            <div class="mb-3 d-flex justify-content-center">
                <a href="#" class="btn btn-see-all text-white" style="padding: 1rem 2rem; font-size: 1.1rem; display: inline-flex; align-items: center; gap: 0.7rem;" onclick="alert('Fitur peminjaman buku ini belum tersedia🙏')">
