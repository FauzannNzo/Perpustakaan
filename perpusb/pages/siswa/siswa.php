...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    <li class="nav-item">
                        <a class="nav-link active" href="siswa.php"><i class="fas fa-home me-1"></i>Beranda</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="hero-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h1 class="display-4 fw-bold mb-4">Selamat Datang di Perpustakaan, <?php echo htmlspecialchars($user['name']); ?></h1>
                    ...
                    <a href="katalog.php" class="btn btn-see-all text-white">Jelajahi Buku</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5 mt-5">
                    ...
                    <div class="col-md-4">
                        <div class="card category-card shadow-sm h-100">
                            <div class="card-body text-center p-5">
                                ...
                                <a href="katalog.php?kategori=<?= urlencode($kategori['nama']) ?>" class="btn btn-outline-primary rounded-pill">Lihat Buku</a>
                            </div>
                        </div>
                    </div>
                <?php
        ...
        <div class="text-center mt-4">
            <a href="kategori.php" class="btn btn-see-all text-white">Lihat Semua Kategori</a>
        </div>
    </section>
